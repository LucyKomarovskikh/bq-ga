...
class MainHandler(webapp2.RequestHandler):
    ...
    def process_ga_params(self, params):
        ...
        ua_parsed = parse(ua)
        data['device']['userAgent'] = ua
        data['deviceBrowser'] = ua_parsed.browser.family
        data['deviceBrowserVersion'] = ua_parsed.browser.version_string
        data['deviceOS'] = ua_parsed.os.family
        data['deviceOSVersion'] = ua_parsed.os.version_string
        data['deviceFamily'] = ua_parsed.device.family
        data['deviceBrand'] = ua_parsed.device.brand
        data['deviceModel'] = ua_parsed.device.model
        data['deviceIsMobile'] = ua_parsed.is_mobile
        data['deviceIsTablet'] = ua_parsed.is_tablet
        data['deviceIsTouchCapable'] = ua_parsed.is_touch_capable
        data['deviceIsPc'] = ua_parsed.is_pc
        data['deviceIsBot'] = ua_parsed.is_bot
        data['deviceType'] = 'undefined'
        if ua_parsed.is_tablet:
            data['deviceType'] = 'tablet'
        elif ua_parsed.is_mobile:
